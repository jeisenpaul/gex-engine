...
def levels(df, spot, label="", days=30, iv_change=0.0, price_change=0.0,
    ...
    level_strength = score_level_strength(by_strike, spot, {
        ...
        "Call Wall": call_wall,
        "Put Wall": put_wall,
        "Secondary Call Node": secondary_call_wall,
        "Secondary Put Node": secondary_put_wall,
        "Call DEX Wall": call_delta_wall,
        "Put DEX Wall": put_delta_wall,
        "Max Pain": max_pain,
...
def gex_chart(filt, lvl, spot, label):
    ...
    (lvl["Secondary Call Wall"], "#66ffa6", "--", 1.4, f"2ND CALL {lvl['Secondary Call Wall']}"),
    (lvl["Secondary Put Wall"], "#ff8a80", "--", 1.4, f"2ND PUT {lvl['Secondary Put Wall']}"),
