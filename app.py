...
def build_scaled_index(symbol, index_symbol, fallback_scale, override, override_min,
    ...
    odte = compute_0dte_walls(ticker, symbol, display_label, display_spot, etf_spot)
...
def compute_0dte_walls(ticker_obj, ticker_symbol, display_label, display_spot, etf_spot):
    ...
    scale = display_spot / etf_spot
    calls["strike"] = (calls["strike"] * scale).round(1)
    puts["strike"] = (puts["strike"] * scale).round(1)
