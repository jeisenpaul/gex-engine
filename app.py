...
<div style="background:#0d1117;border:1px solid #1a2a3a;border-radius:8px;padding:10px 16px 6px 16px;
  ...
  CFD SPOT REQUIRED &nbsp;-&nbsp; enter your broker US500 / US100 CFD spot before generating levels
</div>
""", unsafe_allow_html=True)

ov_col1, ov_col2 = st.columns(2)
with ov_col1:
    us500_override = st.number_input("US500 CFD spot required", min_value=0.0, value=0.0, step=0.1, format="%.1f")
with ov_col2:
    us100_override = st.number_input("US100 CFD spot required", min_value=0.0, value=0.0, step=0.1, format="%.1f")
